...
def train():
    ...
    for i in range(FLAGS.max_steps):
	    ...
	    global_step_val = tf.train.global_step(sess,global_step)
            ...
            summary_str = sess.run(summary, feed_dict=feed_dict, options=options, run_metadata=run_metadata)
...
if __name__ == "__main__":
    class Flags():
     def __init__(self):
        self.data_dir = '/uufs/chpc.utah.edu/common/home/u1142888/Chiron-0.3/test_data_raw'
